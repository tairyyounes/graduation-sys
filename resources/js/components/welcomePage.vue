  ...
  <div class="min-h-screen bg-gradient-to-b from-[#f4fbfc] to-[#f8fcfd] font-sans text-gray-900 relative overflow-hidden">
    ...
    <nav class="flex items-center justify-between px-6 py-4 bg-transparent max-w-7xl mx-auto relative z-10">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <div class="text-[11px] text-gray-500 font-medium tracking-wide">College of Computer Technology — Tripoli</div>
        </div>
      </div>

      <div class="hidden md:flex space-x-8 text-sm font-semibold text-gray-500">
        <a href="#" class="text-gray-800 transition-colors">Home</a>
        <a href="#" class="hover:text-gray-800 transition-colors">Features</a>
        <a href="#" class="hover:text-gray-800 transition-colors">How it works</a>
      </div>

      <div class="flex items-center space-x-4">
        <button class="flex items-center space-x-1.5 text-sm font-semibold text-gray-700 hover:text-gray-900 transition-colors">
    ...
    <main class="max-w-[1000px] mx-auto px-6 pt-24 pb-20 text-center relative z-10">
      ...
      <h1 class="text-[3.5rem] md:text-[4rem] font-[800] text-[#0a1827] tracking-tight leading-[1.1] mb-6">
        Detect proposal similarity <br />
        <span class="text-[#0d7f95]">before approval.</span>
      </h1>

      <p class="text-lg md:text-[1.15rem] text-gray-500 max-w-[800px] mx-auto mb-12 leading-relaxed font-medium">
        An academic platform that helps students submit proposals and helps departments make confident accept, reject, or revise decisions — backed by semantic AI.
      </p>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
        <div class="bg-white rounded-2xl py-8 px-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-gray-100 flex flex-col items-center justify-center hover:-translate-y-1 transition-transform duration-300">
          ...
          <div class="text-[13px] text-gray-500 font-semibold">Proposals analyzed</div>
        </div>
        <div class="bg-white rounded-2xl py-8 px-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-gray-100 flex flex-col items-center justify-center hover:-translate-y-1 transition-transform duration-300">
          <div class="text-[2rem] font-[800] text-[#0a1827] mb-1">94%</div>
          <div class="text-[13px] text-gray-500 font-semibold">Semantic accuracy</div>
        </div>
        <div class="bg-white rounded-2xl py-8 px-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-gray-100 flex flex-col items-center justify-center hover:-translate-y-1 transition-transform duration-300">
          <div class="text-[2rem] font-[800] text-[#0a1827] mb-1">3</div>
          <div class="text-[13px] text-gray-500 font-semibold">Departments</div>
        </div>
        <div class="bg-white rounded-2xl py-8 px-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-gray-100 flex flex-col items-center justify-center hover:-translate-y-1 transition-transform duration-300">
          <div class="text-[2rem] font-[800] text-[#0a1827] mb-1">&lt; 30s</div>
          <div class="text-[13px] text-gray-500 font-semibold">Avg. review time</div>
        </div>
      </div>
    </main>
  </div>
